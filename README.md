...
1. 기존 javascript를 typescript로 변환

- 프로젝트 확장 시 안정적인 코딩을 위해 변환

2. 코드 분할

- 아토믹 디자인 패턴에 가깝게 분할할 예정
- 기존 코드가 컴포넌트간 의존성이 높고, 비즈니스로직이 ui와 많이 섞여있음

3. 반응형 디자인 추가

- 리팩터링과 더불어 반응형 디자인을 추가하여 더 많은 사용자 유입을 기대함

4. 새로운 기능 수정 및 추가

- 백엔드 팀원 한 명과 협업하여 기능 추가 및 수정 예정
  - 예약 현황 기능 추가 (예약현황 크롤링으로 추가 예정)
  - 뱃지 달성 기능 수정 (기존 수동 획득 -> 조건 달성시 자동 획득)
  - 마이페이지 기능 대폭 수정 (협의 중)
